"""Runtime engine implementation shared by root and workspace entrypoints."""
...
def _debug_log(message: str) -> None:
    ...
    workspace_log = root_dir / "workspace" / "results.log"
    log_path = workspace_log if workspace_log.parent.is_dir() else root_dir / "results.log"
