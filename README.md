...
- all real stdout/stderr emitted by `run.sh`
- benchmark JSON when `benchmark_throughput.py` runs
- It is now used as a raw aggregated run artifact rather than a generated summary.
